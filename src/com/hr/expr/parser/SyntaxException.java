...
public class SyntaxException extends Exception {
	...
	private void explainWhere(StringBuilder sb) {
		if (scanner.isEmpty()) {
	...
	private void explainWhy(StringBuilder sb) {
		switch (reason) {
			case INCOMPLETE:
				if (isLegalToken())
	...
	private void explainWhat(StringBuilder sb) {
		fixedInput = tryToFix();
		if (null != fixedInput) {
	...
	private void quotify(StringBuilder sb, String s) {
		sb.append('"');
		sb.append(s);
		sb.append('"');
	}
